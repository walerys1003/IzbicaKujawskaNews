...
auth.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'POST', path: '/api/v1/auth/2fa/verify' },
    ...
    { method: 'DELETE', path: '/api/v1/auth/account', auth: true },
    { method: 'GET', path: '/api/v1/auth/api-keys', auth: true, role: 'author+' },
    { method: 'POST', path: '/api/v1/auth/api-keys', auth: true, role: 'author+' },
    { method: 'DELETE', path: '/api/v1/auth/api-keys', auth: true, role: 'author+' },
