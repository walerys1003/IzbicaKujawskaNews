...
export const CATEGORIES: Category[] = [
  ...
  // ─────────────────────────────────────────────────────────── 5. KUJAWIANKA
  {
    ...
    subcategories: [
      ...
      sub('kujawianka', 'mecze', 'Mecze', 'Zapowiedzi meczowe i relacje pomeczowe: wynik, bramki, przebieg, ocena.'),
      sub('kujawianka', 'tabela', 'Wyniki', 'Tabela Klasy Okręgowej gr. 2 oraz terminarz rozgrywek — aktualizacja po kolejce.'),
      sub('kujawianka', 'kadra', 'Kadra', 'Lista zawodników, sztab szkoleniowy, zarząd klubu.'),
      sub('kujawianka', 'junior', 'Junior', 'Drużyny juniorskie, młodzieżowe, szkółka piłkarska — wyniki i turnieje.'),
      sub('kujawianka', 'historia', 'Historia', 'Od 1949 roku do dziś: sezony, sukcesy, legendy klubu, old boys, rocznice.'),
